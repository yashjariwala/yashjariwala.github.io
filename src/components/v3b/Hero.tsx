  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute z-[6] cursor-pointer bottom-[1%] sm:bottom-[5%] left-0 right-0 sm:left-[4%] sm:right-auto w-fit mx-auto sm:mx-0 flex flex-col items-center gap-1.5 sm:gap-2"
